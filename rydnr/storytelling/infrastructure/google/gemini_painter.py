...
"""
rydnr/storytelling/infrastructure/google/gemini_painter.py

This file defines the GeminiPainter lass.
...
class GeminiPainter(Painter):
    """
    Google Gemini's implementation of the Painter port.

    Class name: GeminiPainter
    ...
    def __init__(self):
        """
        Creates a new GeminiPainter instance.
        """
        super().__init__()
