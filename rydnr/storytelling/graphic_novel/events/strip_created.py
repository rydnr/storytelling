...
"""
rydnr/storytelling/graphic_novel/events/strip_created.py

This file defines StripCreated class.
...
class StripCreated(Event):
    """
    A strip is created.

    Class name: StripCreated

    Responsibilities:
        - Represent the moment in which a strip has been created.
    ...
    def __init__(
        ...
        """
        Creates a new StripCreated instance.
